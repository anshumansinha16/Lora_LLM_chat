...
from utils.io import set_logging
...
def train(
    ...
    data_path: str = "/content/data_f/alpaca_data_gpt4.json",
    output_dir: str = "/content/lora-alpaca/",
...
if __name__ == "__main__":
    ...
    logger.info(f"name: Anshuman Sinha")
    logger.info(f"GTID: {903843345}")
